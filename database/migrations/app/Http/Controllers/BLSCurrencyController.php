...
class BLSCurrencyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('SystemConfiguration/LoanSetup/Currencies/Index', [
    ...
    {
        return inertia('SystemConfiguration/LoanSetup/Currencies/Create');
    }
    ...
    {
        return inertia('SystemConfiguration/LoanSetup/Currencies/Edit', [
            'currency' => $currency,
        ]);
    }
