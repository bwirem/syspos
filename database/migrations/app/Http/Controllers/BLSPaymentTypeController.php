...
class BLSPaymentTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('SystemConfiguration/LoanSetup/PaymentTypes/Index', [
    ...
    public function create()
    {
        ...
        return inertia('SystemConfiguration/LoanSetup/PaymentTypes/Create', [
    ...
    {
        $chartofaccounts = ChartOfAccount::all(); // No pagination
        return inertia('SystemConfiguration/LoanSetup/PaymentTypes/Edit', [
