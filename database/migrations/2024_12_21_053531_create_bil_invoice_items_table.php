...
return new class extends Migration
{
    ...
    {
        Schema::create('bil_invoiceitems', function (Blueprint $table) {
            $table->id();
            
            // Define foreign keys using foreignId
            $table->foreignId('invoice_id')->constrained('bil_invoices')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('bil_invoiceitems');
    }
};
