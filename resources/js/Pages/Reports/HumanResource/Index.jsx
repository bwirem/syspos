        ...
        >
            ...
            <div className="py-8 md:py-12">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Section 3: Human Resource Reports */}
                    <section>
                        <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4 uppercase tracking-wider">
                            HR Reports
                        </h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
                            <ActionOrReportCard
                                ...
                                linkText="View Employee Data"
                            />
                            <ActionOrReportCard
                                title="Payroll Summary Report"
                                description="Overview of payroll expenses per period."
                                icon={faMoneyCheckAlt} // Consistent
                                iconBgColor="bg-purple-600"
                                linkRoute="reports.hr.payroll_summary"
                                linkText="View Payroll Report"
                            />
                            <ActionOrReportCard
                                title="Leave Balance Report"
                                description="Track available leave days for employees."
                                icon={faCalendarAlt} // Consistent
                                iconBgColor="bg-yellow-600"
                                linkRoute="reports.hr.leave_balances"
                                linkText="View Leave Balances"
                            />
                            <ActionOrReportCard
                                title="Attendance Summary"
                                description="Report on punctuality, absenteeism, and overtime."
                                icon={faClock} // Consistent
                                iconBgColor="bg-teal-600"
                                linkRoute="reports.hr.attendance_summary"
                                linkText="Analyze Attendance"
                            />
                            <ActionOrReportCard
                                title="Recruitment Pipeline"
                                description="Status of candidates for open positions."
                                icon={faBriefcase} // Consistent
                                iconBgColor="bg-green-600"
                                linkRoute="reports.hr.recruitment_pipeline"
                                linkText="Track Candidates"
                            />
                            <ActionOrReportCard
                                title="Employee Turnover Report"
                                description="Analyze rate of employees leaving the company."
                                icon={faUserTie} // or faUserMinus
                                iconBgColor="bg-red-600"
                                linkRoute="reports.hr.turnover"
                                linkText="Analyze Turnover"
                            />
                             <ActionOrReportCard
                                title="Employee Demographics"
                                description="Breakdown of workforce by age, gender, department, etc."
                                icon={faUsers} // Consistent
                                iconBgColor="bg-cyan-600"
                                linkRoute="reports.hr.demographics"
                                linkText="View Demographics"
                            />
                            <ActionOrReportCard
                                title="Custom HR Report"
                                description="Build reports with specific HR data filters."
                                icon={faFilter}
                                iconBgColor="bg-gray-600"
                                linkRoute="reports.hr.custom"
