...
export default function Index({ auth, orders, filters }) {
    ...
    useEffect(() => {
        get(route("billing0.index"), { preserveState: true });
    ...
    const handleModalConfirm = async () => {
        try {
            await router.delete(route("billing0.destroy", modalState.orderToDeleteId));
        } catch (error) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-gray-800">Order List</h2>}
        >
