...
export default function Edit({ store }) {
    ...
    const handleSubmit = (e) => {
        ...
        put(route('systemconfiguration2.stores.update', store.id), {
            ...
            onError: (errors) => {
                ...
                setIsSaving(false);
                showAlert('An error occurred while saving the store.');
            },
        });
    };
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Store</h2>}
        >
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4 mt-6">
                                <button
                                    type="button"
                                    onClick={() => Inertia.get(route('systemconfiguration2.stores.index'))}
