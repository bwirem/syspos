...
export default function ItemGroupForm({ itemgroup = null }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (itemgroup) {
            ...
            post(route('systemconfiguration0.itemgroups.store'), {
                onSuccess: () => reset(),
            });
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end items-center gap-4 pt-4 border-t">
                <Link href={route('systemconfiguration0.itemgroups.index')} className="text-gray-700 font-medium">
                    Cancel
                </Link>
                <button
                    type="submit"
