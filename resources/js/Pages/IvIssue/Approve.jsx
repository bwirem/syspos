...
export default function Approve({ requistion,fromstore,tostore }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Goods Approval</h2>}
        >
            <Head title="Goods Approval" />
            <div className="py-12">
            ...
            >
                <div>
                    <p>
                        Are you sure you want to approve the order to <strong>
