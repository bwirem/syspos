...
export default function Index({ auth, requistions, fromstore, filters }) {
    ...
    useEffect(() => {
        get(route("inventory1.index"), {
            preserveState: true,
            replace: true,
        });
    }, [data.search, data.stage, data.fromstore]);
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-800">Issue List</h2>}>
                    ...
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-2 py-2 border rounded text-sm ${errors.search ? "border-red-500" : ""}`}
                            />
                        </div>
                    </div>
