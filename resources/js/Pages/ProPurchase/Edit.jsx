                                                    ...
                                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-600 bg-white dark:bg-gray-800">
                                                        {purchaseItemsUI.map((item, index) => (
                                                            <tr key={item.id || item.item_id || `new-${index}`}> {/* Use item.id for existing items */}
                                                                <td className="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-gray-100 sm:pl-6">{item.item_name}<div className="text-xs text-gray-500 dark:text-gray-400">Product ID: {item.item_id}</div> {item.id && <div className="text-xs text-gray-400 dark:text-gray-500">PO Item ID: {item.id}</div>}</td>
