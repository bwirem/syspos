...
export default function Edit({ usergroup }) {
    ...
    const handleSubmit = (e) => {
        ...
        put(route('usermanagement.usergroups.update', usergroup.id), {
            ...
            onError: (errors) => {
                ...
                setIsSaving(false);
                showAlert('An error occurred while saving the usergroup.');
            },
        });
    };
    ...
    const resetForm = () => {
        reset();
        showAlert('Usergroup updated successfully!');
    };
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4 mt-6">
                                <Link
                                    href={route('usermanagement.usergroups.index')}  // Using the route for navigation
